...
import { CreateMetricDto, GetAthleteMetricsQueryDto, GetAthletesLeaderboardQueryDto } from 'src/dto/metric.dto';
 ...
 */
metricsRoutes.get('/athletes/:id/metrics/aggregate', classValidator('param', GetAthleteQueryDto), async (context) => {
